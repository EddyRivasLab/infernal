...
\abstract{Covariance models (CMs) are probabilistic models of RNA
...
practical for small RNAs. Here I describe a divide and conquer variant
of the alignment algorithm that is analogous to memory-efficient
Myers/Miller dynamic programming algorithms for linear sequence
alignment. The new algorithm has an $O(N^2 \log N)$ memory complexity,
at the expense of a small constant factor in time. Optimal ribosomal
