...
%The benchmark dataset used in Figure~1 is described in detail in
%\citep{NawrockiEddy07}. It includes query alignments and test
%sequences from 51 \textsc{Rfam} (release 7) families. 
...
%many large RNA sequences need to be aligned. One of the main
%ribosomal RNA databases, RDP, has recently adopted \textsc{infernal}
%into it's pipeline \citep{Cole09}.
