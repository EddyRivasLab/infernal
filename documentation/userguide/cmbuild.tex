...
where the Dirichlet parameters $\alpha$ are currently all hardcoded to
1.0 (e.g. an uninformative plus-one, or Laplace, prior). (This is
actually a pretty bad prior.)
