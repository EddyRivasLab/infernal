...
\item \textbf{Glocal-mode E-value accuracy for large and huge
  ...
  predictor and \prog{cmcalibrate}. Users who rely on glocal-mode
  E-values for very large models should treat them with caution and,
  where accuracy is critical, validate with \prog{cmcalibrate}.
