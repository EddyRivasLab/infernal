...
Download \prog{infernal-1.1.3.tar.gz} from \url{http://eddylab.org/infernal/}, or
directly from \\
\url{eddylab.org/infernal/infernal-1.1.3.tar.gz};
unpack it, configure, and make:

\user{wget eddylab.org/infernal/infernal-1.1.3.tar.gz}\\
\user{tar xf infernal-1.1.3.tar.gz}\\
\user{cd infernal-1.1.3}\\
\user{./configure}\\ 
\user{make}
