...
\software{Infernal} can optionally support Large File System (LFS)
...
enabled with the \prog{--enable-lfs} option:
...
\user{env CFLAGS="-O3" ./configure --enable-mpi --enable-lfs --prefix=/usr/local/infernal-1}
