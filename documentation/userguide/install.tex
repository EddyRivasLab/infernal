...
Download \prog{infernal-1.1rc4.tar.gz} from \url{http://infernal.janelia.org/}, or

directly from
\url{ftp://selab.janelia.org/pub/software/infernal/infernal-1.1rc4.tar.gz};
unpack it, configure, and make:

\user{wget ftp://selab.janelia.org/pub/software/infernal/infernal-1.1rc4.tar.gz}\\
\user{tar xf infernal-1.1rc4.tar.gz}\\
\user{cd infernal-1.1rc4}\\
\user{./configure}\\ 
\user{make}
