...
At the time of writing, a paper describing Infernal 1.1 has been
accepted at Bioinformatics\citep{Nawrocki13c} but is only available
via Epub ahead of print. As you read this, it is probably now
available in print and therefore more easily citable; please cite that
paper if you wish to cite Infernal 1.1.
\end{srefaq}
