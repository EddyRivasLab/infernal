...
static ESL_OPTIONS options[] = {
  ...
  { "--nop7b_cp9b",   eslARG_NONE, FALSE, NULL, NULL,    NULL,  NULL,        NULL, "don't use p7 bands for CP9 F/B banding",                              106 },
  { "--p7b_to_cp9b",  eslARG_NONE, FALSE, NULL, NULL,    NULL,  NULL,        NULL, "convert p7 bands directly to CP9 bands",                  106 },
  ...
  { "--p7bppad",   eslARG_INT,   NULL,  NULL, "n>=0",  NULL,  NULL, "--p7bmisc", "set pair-position band pad (default: --p7bpad)",                         106 },
  { "--p7bmisc",   eslARG_REAL,  NULL,  NULL, "x>0",   NULL,  NULL, "--p7bppad,--p7bmidiff", "scale MI to set per-node pad: pad + scale*MI",                106 },
  { "--p7bmidiff", eslARG_REAL,  NULL,  NULL, "x>0",   NULL,  NULL, "--p7bppad,--p7bmisc", "MI diffusion scale for per-node pad",                            106 },
