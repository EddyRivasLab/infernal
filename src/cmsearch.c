...
static ESL_OPTIONS options[] = {
  ...
  { "--msvband",   eslARG_NONE,   FALSE, NULL, NULL,    NULL,  NULL, NULL, "use MSV-derived bands for F4/F5 (experimental; disables default vitband)", 106 },
  ...
  { "--nop7post_cp9b", eslARG_NONE, FALSE, NULL, NULL,   NULL,  NULL, NULL, "disable default p7post_cp9b (CP9 bands from p7 posteriors)",                                     106 },
  ...
  { "--p7padplus",  eslARG_INT,    "0", NULL, "n>=0", NULL, NULL, NULL, "add <n> to every per-state pad",                                                            106 },
