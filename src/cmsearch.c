...
static ESL_OPTIONS options[] = {
  ...
  { "--msvband",   eslARG_NONE,   FALSE, NULL, NULL,    NULL,  NULL, "--vitband", "use MSV-derived bands for F4/F5 (experimental; disables default --vitband)", 106 },
  { "--vitband",   eslARG_NONE,   FALSE, NULL, NULL,    NULL,  NULL, "--msvband,--novitband", "[deprecated: on by default] Viterbi-derived bands for F4/F5",            106 },
  { "--novitband", eslARG_NONE,   FALSE, NULL, NULL,    NULL,  NULL, "--vitband", "disable default --vitband (F4/F5 unbanded)",                                   106 },
  { "--vitblocal", eslARG_NONE,   FALSE, NULL, NULL,    NULL,  NULL, "--novitband,--msvband", "with --vitband, use local Viterbi instead of glocal",                  106 },
  { "--p7post_cp9b",  eslARG_NONE, FALSE, NULL, NULL,    NULL,  NULL, "--nop7post_cp9b", "[deprecated: on by default] derive CP9 bands from p7 F/B posteriors",                       106 },
  { "--nop7post_cp9b", eslARG_NONE, FALSE, NULL, NULL,   NULL,  NULL, "--p7post_cp9b", "disable default --p7post_cp9b",                                                                     106 },
  ...
  { "--p7nodepad-file", eslARG_INFILE, NULL, NULL, NULL, NULL, NULL, "--novitband,--msvband", "read per-state p7 pads from <f> (requires --vitband, on by default)",                 106 },
