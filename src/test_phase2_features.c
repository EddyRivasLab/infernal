/* test_phase2_features.c
 * Phase 2 verification: extract features from a CM file and print them.
 *
 * Usage: ./test_phase2_features <cm_file>
 *
...
main(int argc, char **argv)
{
  ...
  double        feats[FAST_CAL_NFEAT_PHASE2];
  int           i;
  int           ncm  = 0;
  int           hstatus;
  int           status;
  ...
  if (argc != 2) {
    fprintf(stderr, "usage: test_phase2_features <cm_file>\n");
    return 1;
  }
