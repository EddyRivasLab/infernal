...
extern int  cm_TrPosterior       (CM_t *cm, char *errbuf,               int L, float size_limit, char mode, CM_TR_MX *ins_mx, CM_TR_MX *out_mx, CM_TR_MX *post_mx);
...
extern void cm_TrModeFromAlphas  (CM_TR_MX *mx, int W, char *ret_mode, float *ret_sc);
