...
# Embed the 12 production JSON model files into a C header as unsigned char arrays.
 ...
 * Embeds the 12 production JSON model files as C char arrays.
...
/* SHA-256 of the concatenated content of all 12 production JSON files.
