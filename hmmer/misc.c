 ...
 *    variable          example
 *    --------           --------------  
 *    HMMER_PACKAGE_NAME      "HMMER"
 *    HMMER_PACKAGE_VERSION   "2.0.42"
 *    HMMER_PACKAGE_DATE      "April 1999"
 *    HMMER_PACKAGE_COPYRIGHT "Copyright (C) 1992-1999 Washington University School of Medicine"
 *    HMMER_PACKAGE_LICENSE   "Freely distributed under the GNU General Public License (GPL)."
 *           
...
{
  fprintf(fp, "%s\n", banner);
  fprintf(fp, "%s %s (%s)\n", HMMER_PACKAGE_NAME, HMMER_PACKAGE_VERSION, HMMER_PACKAGE_DATE);
  fprintf(fp, "%s\n", HMMER_PACKAGE_COPYRIGHT);
  fprintf(fp, "%s\n", HMMER_PACKAGE_LICENSE);
  fprintf(fp, "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n");
}
