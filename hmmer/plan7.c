...
AllocPlan7Body(struct plan7_s *hmm, int M) 
{
  ...
  hmm->ins[0] = MallocOrDie ((HMMERMAXABET*M) *     sizeof(float));
 ...
 */
void
Plan7SetNullModel(struct plan7_s *hmm, float null[HMMERMAXABET], float p1)
{
  int x;
