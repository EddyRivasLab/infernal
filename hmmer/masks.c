...
{
  float p[HMMERMAXABET];		/* null model distribution */
...
{
  float ct[HMMERMAXABET];		/* counts of observed residues            */
  float p[HMMERMAXABET];		/* null2 model distribution (also counts) */
