 ...
 * CVS $Id: hmmbuild.c 970 2004-10-08 21:00:13Z dbrooks $
 */
...
\n\
  Alternative model construction strategies: (default: --fast)\n\
   ...
   --gapmax <x>  : for --fast: max fraction of gaps in MAT column {1.0} [0..1]\n\
\n\
...
main(int argc, char **argv)
{
  ...
  float  randomseq[HMMERMAXABET];	/* null sequence model                     */
...
--eloss <x> explicitly, in addition to selecting --effent.\n");
       ...
       */
      hmmer_DigitizeAlignment(msa, &dsq);
